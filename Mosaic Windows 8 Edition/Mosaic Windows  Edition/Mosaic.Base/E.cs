...
namespace Mosaic.Base
{
    ...
    public static class E
    {
        ...
        public static string Config { get { return Root + "\\Mosaic.config"; } }
        ...
        public static void SetAutoStart(bool autostart)
        {
            ...
            if (autostart)
            {
                regSUK.SetValue("Mosaic Windows 8 Edition", Process.GetCurrentProcess().MainModule.FileName + " -winstart");
            }
            else
            {
                regSUK.DeleteValue("Mosaic Windows 8 Edition", false);
            }
        }
        ...
        public static bool GetAutoStart()
        {
            RegistryKey regSUK = Registry.CurrentUser.OpenSubKey("SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run", true);
            bool result = false;
            if (regSUK.GetValue("Mosaic Windows 8 Edition", null) != null) result = true;
            return result;
        }
    }
}